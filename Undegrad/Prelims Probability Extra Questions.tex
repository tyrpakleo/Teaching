...
Extra:
\begin{itemize}
    \item Q2: give a few more terms of the asymptotic expansion of the quantity you get and give precise error bounds. (Hint:Taylor)
    ...
    \item Q7: What happens when \(p=a,b\)? Prove the law of large numbers for Bernoulli random variables. How would you start this question?
\end{itemize}
