...
\begin{itemize}
    ...
    \item Q6: Explain intuitively why we have a lower variance for \(d\) than for \(c\). Does lower variance, same mean imply concentration around the mean? Why? Calculate higher order moments for the random variables in part \(c,d\), at least to leading order of \(n\). 
